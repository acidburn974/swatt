...
CREATE TABLE `peers` (
`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
`peer_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
`md5_peer_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
`hash` varchar(255) NULL,
`ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
`port` smallint(5) UNSIGNED NULL,
`uploaded` bigint(20) UNSIGNED NULL,
`downloaded` bigint(20) UNSIGNED NULL,
`left` bigint(20) UNSIGNED NULL,
`seeder` tinyint(4) NULL,
`created_at` datetime NULL DEFAULT NULL,
`updated_at` datetime NULL DEFAULT NULL,
`torrent_id` bigint(20) UNSIGNED NULL,
`user_id` int(11) NULL,
PRIMARY KEY (`id`) ,
