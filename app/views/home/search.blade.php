...
@section('title')
<title>Recherche - {{{ Config::get('other.title') }}}</title>
@stop

@section('meta')
<meta name="description" content="{{{ 'Résultats de recherche de fichiers torrents sur Ralamoin.com' }}}">
@stop

@section('breadcrumb')
<div class="l-breadcrumb-item" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
    <a href="{{ route('torrents') }}" itemprop="url" class="l-breadcrumb-item-link">
        <span itemprop="title" class="l-breadcrumb-item-link-title">Recherche</span>
    </a>
</div>
@stop
...
<div class="container box">
    <div class="torrents col-md-12">
        <h1 class="torrents-title">Recherche</h1>
